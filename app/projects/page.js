    ...
    return (
        <div className="min-h-screen  flex flex-col gap-10 p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
                {/* Project 1: Bidsphere - online auction platform */}
                <div className="bg-yellow-200 shadow-lg rounded-lg p-6 flex flex-col gap-4">
                    <img src="bidsphere.png" alt="Emerald Courier Service" className="rounded-md w-full h-48 object-cover" />
                    <h2 className="text-2xl font-semibold text-gray-800">Bidsphere - online auction platform</h2>
                    <p className="text-gray-600">
                        BidSphere is a dynamic and user-friendly online auction platform developed using the MERN stack (MongoDB, Express.js, React.js, Node.js). It is designed to facilitate seamless bidding and listing of items through a secure, real-time system. The platform features JWT-based authentication, intuitive interfaces for buyers and sellers, and distinct sections to manage active bids, won auctions, and posted listings—ensuring a transparent and efficient auction experience for all users.
                    </p>
                    <a href="https://github.com/29Krishna/BidSphere-Online-Auction-Platform" className="text-blue-600 hover:underline">View Project</a>
                </div>

                {/* Project 2: Emerald Courier Service System */}
                <div className="bg-yellow-200 shadow-lg rounded-lg p-6 flex flex-col gap-4">
                    ...
                    <a href="https://github.com/29Krishna/Emerald-Courier-Service-System" className="text-blue-600 hover:underline">View Project</a>
                </div>

                {/* Project 3: Chatbot for GATE 2025 */}
                <div className="bg-yellow-200 shadow-lg rounded-lg p-6 flex flex-col gap-4">
                ...
                {/* Project 5: LockVault - Password Manager */}
                <div className="bg-yellow-200 shadow-lg rounded-lg p-6 flex flex-col gap-4">
                    ...
                    <a href="https://github.com/29Krishna/LockVault-PasswordManager" className="text-blue-600 hover:underline">View Project</a>
                </div>
            </div>
        </div>
    )
